...
✅ Next step (to save and push this):

cd ~/BSDSF23A031-OS-A02
nano REPORT.md   # paste this content
git add REPORT.md
git commit -m "docs: added Feature 2 report answers (stat vs lstat and st_mode explanation)"
git push origin feature-long-listing-v1.1.0
